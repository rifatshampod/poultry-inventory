                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="flock-sales-report" method="POST">
                                    @csrf
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="farm-sales-report" method="POST">
                                    @csrf
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="house-sales-report" method="POST">
                                    @csrf
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="date-sales-report" method="POST">
                                    @csrf
