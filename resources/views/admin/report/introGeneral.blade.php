                ...
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="javascript:void(0)">General Report</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="flock-general-report" method="POST">
                                    @csrf
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="farm-general-report" method="POST">
                                    @csrf
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="house-general-report" method="POST">
                                    @csrf
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="date-general-report" method="POST">
                                    @csrf
